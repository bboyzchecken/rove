...
- [ ] D26.1 รันแบบสำรวจ **Van Westendorp** กับผู้ใช้จริง 100–200 คนก่อนล็อกราคาถาวร (ดู [docs/business-plan.md](docs/business-plan.md) §7) — ฿299 มาจากการบรรจบของ 4 มุม แต่มุมที่สี่คือความยินดีจ่ายซึ่ง**ยังไม่เคยวัดจริง**  ·  **ยังค้าง — เป็นงานของคน ไม่ใช่ของโค้ด** · บันทึกไว้ในหัวข้อ "สิ่งที่ยังไม่ได้ตัดสินใจ" ของ [decision-log.md](docs/decision-log.md) แล้ว
