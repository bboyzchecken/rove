...
const BENEFITS = [
  {
    icon: Ticket,
    title: `คืนได้อีกสูงสุด ฿${TRIP_PASS_PRICE_THB}`,
    body: `Trip Pass คืนหนึ่งครั้งต่อทริป — ทริปใหม่ที่พาร์ตเนอร์ยืนยันการจองก็คืนได้อีกสูงสุด ฿${TRIP_PASS_PRICE_THB} ส่วนทริปเดิมที่วางทับไปเรื่อย ๆ คืนได้แค่ครั้งเดียวตลอดกาล`,
  },
  {
    icon: NotebookPen,
  ...
  },
  {
    ...
    body: 'ทริปที่ไปมาแล้วเปิดเป็นสาธารณะได้ มีคนก๊อปไปเมื่อไหร่ก็ได้แต้ม เอาไปเป็นส่วนลดทริปหน้า ทริปที่ยังไม่จบทำแบบนี้ไม่ได้',
  },
] as const;
