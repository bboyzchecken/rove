...
| # | คำถาม | กระทบ |
|---|---|---|
| O-1 | ขั้นที่เป็น "ตรวจดู" (วันเดินทางที่พิมพ์เอง, แพลนที่ coverage ไม่ถึง 100%) ควรมีปุ่ม "เรียบร้อยแล้ว" ไหม ถ้าไม่มี % ก็ยังไม่ถึง 100 | F9 |
| O-2 | ทริปที่ถึงวันเดินทางแล้วแต่หัวห้องยังไม่กด "พร้อมไปแล้ว" ควรเข้าโหมดวันเดินทางด้วยไหม | F9 |
| O-3 | ทริปเก่าที่เลยวันกลับไปนานแล้ว (เช่นเกิน 30 วัน) ให้ปิดอัตโนมัติตอนย้ายระบบไหม · ถ้าไม่ปิด รีวิวจะปิดจนกว่าหัวห้องจะกดจบ | F10 |
...
| O-5 | ทริปที่ "เก็บเข้าคลัง" (D-18) นับเป็นทริปที่ยังเปิดอยู่ (กินโควตาฟรี) ไหม | F12 |
| O-6 | ครีเอเตอร์ที่ยังไม่ยืนยันตัวตน รายได้ที่เกิดขึ้นควรเก็บรอ / ไม่เกิด / ให้เป็นแต้มแทน | F11 · PDF |
| O-7 | การจองถูกยกเลิกหลังโอนเงินไปแล้ว → หักจากรอบหน้า (ยอดติดลบ) ไหม | F12 · PDF |
